...
export class ClientProtocolHelper {
  ...
  public static invocationInfoToConsumedMethodReference(
    invocationInfo: InvocationMetaInfo
  ): plexus.interop.protocol.IConsumedMethodReference {
    return {
  ...
  public static discoveredInvocationStartRequestPayload(
    providerMethodReference: plexus.interop.protocol.IProvidedMethodReference
  ): ArrayBuffer {
    return encodeClientToBrokerEnvelop({
      invocationStartRequest: {
  ...
  public static discoveryServiceRequestPayload(
  ...
  public static discoveryMethodRequestPayload(
  ...
  public static decodeMethodDiscoveryResponse(data: ArrayBuffer): plexus.interop.protocol.IMethodDiscoveryResponse {
    ...
    return plexus.interop.protocol.MethodDiscoveryResponse.toObject(
      envelop
    ) as plexus.interop.protocol.IMethodDiscoveryResponse;
  }
  ...
  public static decodeServiceDiscoveryResponse(data: ArrayBuffer): plexus.interop.protocol.IServiceDiscoveryResponse {
    ...
    return plexus.interop.protocol.ServiceDiscoveryResponse.toObject(
      envelop
    ) as plexus.interop.protocol.IServiceDiscoveryResponse;
  }
  ...
  public static decodeClientToBrokerRequest(data: ArrayBuffer): plexus.interop.protocol.IClientToBrokerRequestEnvelope {
    ...
    return plexus.interop.protocol.ClientToBrokerRequestEnvelope.toObject(
      envelop
    ) as plexus.interop.protocol.IClientToBrokerRequestEnvelope;
  }
  ...
  public static decodeBrokerEnvelop(data: ArrayBuffer): plexus.interop.protocol.IBrokerToClientRequestEnvelope {
    ...
    return plexus.interop.protocol.BrokerToClientRequestEnvelope.toObject(
      envelop
    ) as plexus.interop.protocol.IBrokerToClientRequestEnvelope;
  }

  public static decodeInvocationStartRequest(data: ArrayBuffer): plexus.interop.protocol.IInvocationStartRequest {
    const envelop = plexus.interop.protocol.ClientToBrokerRequestEnvelope.decode(new Uint8Array(data));
    const clientToBroker = plexus.interop.protocol.ClientToBrokerRequestEnvelope.toObject(
      envelop
    ) as plexus.interop.protocol.IClientToBrokerRequestEnvelope;
  ...
  public static invocationRequestedPayload(
  ...
  public static decodeInvocationEnvelop(data: ArrayBuffer): plexus.interop.protocol.IInvocationMessageEnvelope {
    ...
    return plexus.interop.protocol.InvocationMessageEnvelope.toObject(
      envelop
    ) as plexus.interop.protocol.IInvocationMessageEnvelope;
  }
