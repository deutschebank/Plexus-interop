...
import { Completion, InvocationRequestInfo, UniqueId } from '@plexus-interop/protocol';

import { InvocationObserver } from '../../generic';
import { InvocationClient } from '../InvocationClient';
import { ValueHandler } from '../ValueHandler';
import { Feature, GenericClientApi } from './GenericClientApi';
...
export abstract class GenericClientApiBase implements GenericClientApi {
  ...
  public sendBidirectionalStreamingRequest(
    invocationInfo: GenericRequest,
