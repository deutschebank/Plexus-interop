...
var $root =
  $protobuf.roots['echo-client'] || ($protobuf.roots['echo-client'] = {});
  ...
  plexus.interop = (function () {
    ...
    interop.testing = (function () {
      ...
      testing.EchoRequest = (function () {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        EchoRequest.encodeDelimited = function encodeDelimited(
          message,
          writer
        ) {
        ...
        EchoRequest.decode = function decode(reader, length) {
          ...
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.plexus.interop.testing.EchoRequest();
        ...
        EchoRequest.SubMessage = (function () {
           ...
           * @returns {$protobuf.Writer} Writer
           */
          SubMessage.encodeDelimited = function encodeDelimited(
            message,
            writer
          ) {
            return this.encode(message, writer).ldelim();
