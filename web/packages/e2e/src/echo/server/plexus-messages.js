...
$root.interop = (function () {
  ...
  interop.ApplicationOptions = (function () {
    ...
    ApplicationOptions.encode = function encode(message, writer) {
      ...
      if (
        message.launchOnCall != null &&
        Object.hasOwnProperty.call(message, 'launchOnCall')
      )
    ...
    ApplicationOptions.verify = function verify(message) {
      ...
      if (
        message.launchOnCall != null &&
        message.hasOwnProperty('launchOnCall')
      )
    ...
    ApplicationOptions.fromObject = function fromObject(object) {
      if (object instanceof $root.interop.ApplicationOptions) return object;
      var message = new $root.interop.ApplicationOptions();
      ...
      if (
        ...
        object.launchOnCall =
          options.enums === String
            ? $root.interop.ApplicationLaunchOnCallMode[message.launchOnCall]
            : message.launchOnCall;
      return object;
    };
  ...
  interop.ProvidedServiceOptions = (function () {
    ...
    ProvidedServiceOptions.fromObject = function fromObject(object) {
      if (object instanceof $root.interop.ProvidedServiceOptions) return object;
      var message = new $root.interop.ProvidedServiceOptions();
      if (object.title != null) message.title = String(object.title);
      switch (object.launchOnCall) {
        case 'IF_NOT_LAUNCHED':
  ...
  interop.ConsumedServiceOptions = (function () {
    ...
    ConsumedServiceOptions.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length;
      var message = new $root.interop.ConsumedServiceOptions();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          default:
    ...
    ConsumedServiceOptions.fromObject = function fromObject(object) {
      if (object instanceof $root.interop.ConsumedServiceOptions) return object;
  ...
  interop.ProvidedMethodOptions = (function () {
    ...
    ProvidedMethodOptions.fromObject = function fromObject(object) {
      if (object instanceof $root.interop.ProvidedMethodOptions) return object;
      var message = new $root.interop.ProvidedMethodOptions();
      if (object.title != null) message.title = String(object.title);
      switch (object.launchOnCall) {
        case 'IF_NOT_LAUNCHED':
  ...
  interop.ConsumedMethodOptions = (function () {
    ...
    ConsumedMethodOptions.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length;
      var message = new $root.interop.ConsumedMethodOptions();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          default:
    ...
    ConsumedMethodOptions.fromObject = function fromObject(object) {
      if (object instanceof $root.interop.ConsumedMethodOptions) return object;
  ...
  plexus.interop = (function () {
    ...
    interop.testing = (function () {
      ...
      testing.EchoService = (function () {
        ...
        (EchoService.prototype = Object.create(
         ...
         */
        EchoService.create = function create(
          rpcImpl,
          requestDelimited,
          responseDelimited
        ) {
        ...
        Object.defineProperty(
          (EchoService.prototype.unary = function unary(request, callback) {
            return this.rpcCall(
              unary,
              $root.plexus.interop.testing.EchoRequest,
              $root.plexus.interop.testing.EchoRequest,
              request,
              callback
            );
         ...
         */
        Object.defineProperty(
          (EchoService.prototype.serverStreaming = function serverStreaming(
            request,
            callback
          ) {
            return this.rpcCall(
         ...
         */
        Object.defineProperty(
          (EchoService.prototype.clientStreaming = function clientStreaming(
            request,
            callback
          ) {
            return this.rpcCall(
         ...
         */
        Object.defineProperty(
          (EchoService.prototype.duplexStreaming = function duplexStreaming(
            request,
            callback
          ) {
            return this.rpcCall(
      ...
      testing.EchoRequest = (function () {
         ...
         * @instance
         */
        EchoRequest.prototype.int64Field = $util.Long
        ...
        EchoRequest.encode = function encode(message, writer) {
          ...
          if (
            ...
            Object.hasOwnProperty.call(message, 'stringField')
          )
            writer
              .uint32(/* id 1, wireType 2 = */ 10)
              .string(message.stringField);
          if (
            message.int64Field != null &&
            Object.hasOwnProperty.call(message, 'int64Field')
          )
            writer
              .uint32(/* id 2, wireType 0 = */ 16)
              .int64(message.int64Field);
          if (
            message.uint32Field != null &&
            Object.hasOwnProperty.call(message, 'uint32Field')
          )
            writer
              .uint32(/* id 3, wireType 0 = */ 24)
              .uint32(message.uint32Field);
          if (
            message.repeatedDoubleField != null &&
            message.repeatedDoubleField.length
          ) {
          ...
          if (
            message.enumField != null &&
            Object.hasOwnProperty.call(message, 'enumField')
          )
            writer.uint32(/* id 5, wireType 0 = */ 40).int32(message.enumField);
          if (
            message.subMessageField != null &&
            Object.hasOwnProperty.call(message, 'subMessageField')
          )
            $root.plexus.interop.testing.EchoRequest.SubMessage.encode(
              message.subMessageField,
              writer.uint32(/* id 6, wireType 2 = */ 50).fork()
            ).ldelim();
          if (
            message.repeatedSubMessageField != null &&
            message.repeatedSubMessageField.length
          )
            for (var i = 0; i < message.repeatedSubMessageField.length; ++i)
              $root.plexus.interop.testing.EchoRequest.SubMessage.encode(
                message.repeatedSubMessageField[i],
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              ...
              case 4:
                ...
                } else message.repeatedDoubleField.push(reader.double());
                break;
              case 5:
              ...
              case 6:
                message.subMessageField =
                  $root.plexus.interop.testing.EchoRequest.SubMessage.decode(
                    reader,
                    reader.uint32()
                  );
                break;
              case 7:
                if (
                  ...
                  message.repeatedSubMessageField = [];
                message.repeatedSubMessageField.push(
                  $root.plexus.interop.testing.EchoRequest.SubMessage.decode(
                    reader,
                    reader.uint32()
                  )
        ...
        EchoRequest.verify = function verify(message) {
          ...
          if (
            message.stringField != null &&
            message.hasOwnProperty('stringField')
          )
            if (!$util.isString(message.stringField))
              return 'stringField: string expected';
          if (
            message.int64Field != null &&
            message.hasOwnProperty('int64Field')
          )
            if (
              !$util.isInteger(message.int64Field) &&
              !(
                message.int64Field &&
                $util.isInteger(message.int64Field.low) &&
                $util.isInteger(message.int64Field.high)
              )
            )
              return 'int64Field: integer|Long expected';
          if (
            message.uint32Field != null &&
            message.hasOwnProperty('uint32Field')
          )
            if (!$util.isInteger(message.uint32Field))
              return 'uint32Field: integer expected';
          if (
            message.repeatedDoubleField != null &&
            message.hasOwnProperty('repeatedDoubleField')
          ) {
          ...
          if (
            message.subMessageField != null &&
            message.hasOwnProperty('subMessageField')
          ) {
            var error =
              $root.plexus.interop.testing.EchoRequest.SubMessage.verify(
                message.subMessageField
              );
            if (error) return 'subMessageField.' + error;
          }
          if (
            message.repeatedSubMessageField != null &&
            message.hasOwnProperty('repeatedSubMessageField')
          ) {
            ...
            for (var i = 0; i < message.repeatedSubMessageField.length; ++i) {
              ...
              if (error) return 'repeatedSubMessageField.' + error;
            }
          }
          return null;
        };
        ...
        EchoRequest.fromObject = function fromObject(object) {
          ...
          if (object.int64Field != null)
            if ($util.Long)
              (message.int64Field = $util.Long.fromValue(
                object.int64Field
              )).unsigned = false;
              ...
              message.int64Field = new $util.LongBits(
                object.int64Field.low >>> 0,
                object.int64Field.high >>> 0
              ).toNumber();
          ...
          if (object.repeatedDoubleField) {
            if (!Array.isArray(object.repeatedDoubleField))
              throw TypeError(
                '.plexus.interop.testing.EchoRequest.repeatedDoubleField: array expected'
              );
            message.repeatedDoubleField = [];
            for (var i = 0; i < object.repeatedDoubleField.length; ++i)
              message.repeatedDoubleField[i] = Number(
                object.repeatedDoubleField[i]
              );
          }
          ...
          if (object.subMessageField != null) {
            if (typeof object.subMessageField !== 'object')
              throw TypeError(
                '.plexus.interop.testing.EchoRequest.subMessageField: object expected'
              );
            message.subMessageField =
              $root.plexus.interop.testing.EchoRequest.SubMessage.fromObject(
                object.subMessageField
              );
          }
          if (object.repeatedSubMessageField) {
            if (!Array.isArray(object.repeatedSubMessageField))
              throw TypeError(
                '.plexus.interop.testing.EchoRequest.repeatedSubMessageField: array expected'
              );
            message.repeatedSubMessageField = [];
            for (var i = 0; i < object.repeatedSubMessageField.length; ++i) {
              if (typeof object.repeatedSubMessageField[i] !== 'object')
                throw TypeError(
                  '.plexus.interop.testing.EchoRequest.repeatedSubMessageField: object expected'
                );
              message.repeatedSubMessageField[i] =
                $root.plexus.interop.testing.EchoRequest.SubMessage.fromObject(
                  object.repeatedSubMessageField[i]
                );
            }
          }
          return message;
        ...
        EchoRequest.toObject = function toObject(message, options) {
            ...
            if ($util.Long) {
              ...
              object.int64Field =
                options.longs === String
                  ...
                  ? long.toNumber()
                  : long;
            } else object.int64Field = options.longs === String ? '0' : 0;
          ...
          if (
            ...
            if (typeof message.int64Field === 'number')
              object.int64Field =
                options.longs === String
                  ? String(message.int64Field)
                  : message.int64Field;
            else
              object.int64Field =
                options.longs === String
                  ? $util.Long.prototype.toString.call(message.int64Field)
                  : options.longs === Number
                  ? new $util.LongBits(
                      message.int64Field.low >>> 0,
                      message.int64Field.high >>> 0
                    ).toNumber()
                  : message.int64Field;
          if (
            message.uint32Field != null &&
          ...
          if (
            ...
            for (var j = 0; j < message.repeatedDoubleField.length; ++j)
              object.repeatedDoubleField[j] =
                options.json && !isFinite(message.repeatedDoubleField[j])
                  ? String(message.repeatedDoubleField[j])
                  : message.repeatedDoubleField[j];
          }
          if (message.enumField != null && message.hasOwnProperty('enumField'))
            object.enumField =
              options.enums === String
                ? $root.plexus.interop.testing.EchoRequest.SubEnum[
                    message.enumField
                  ]
                : message.enumField;
          if (
            ...
            object.subMessageField =
              $root.plexus.interop.testing.EchoRequest.SubMessage.toObject(
                message.subMessageField,
                options
              );
          if (
            ...
            for (var j = 0; j < message.repeatedSubMessageField.length; ++j)
              object.repeatedSubMessageField[j] =
                $root.plexus.interop.testing.EchoRequest.SubMessage.toObject(
                  message.repeatedSubMessageField[j],
                  options
                );
          }
          return object;
        ...
        EchoRequest.SubMessage = (function () {
          ...
          SubMessage.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (
              message.bytesField != null &&
              Object.hasOwnProperty.call(message, 'bytesField')
            )
              writer
                .uint32(/* id 1, wireType 2 = */ 10)
                .bytes(message.bytesField);
            if (
              message.stringField != null &&
              Object.hasOwnProperty.call(message, 'stringField')
            )
          ...
          SubMessage.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length;
            var message =
              new $root.plexus.interop.testing.EchoRequest.SubMessage();
            while (reader.pos < end) {
              var tag = reader.uint32();
              switch (tag >>> 3) {
                case 1:
          ...
          SubMessage.verify = function verify(message) {
            ...
            if (
              message.bytesField != null &&
              message.hasOwnProperty('bytesField')
            )
              if (
                !(
                  (message.bytesField &&
                    typeof message.bytesField.length === 'number') ||
                  $util.isString(message.bytesField)
                )
              )
          ...
          SubMessage.fromObject = function fromObject(object) {
            if (
              object instanceof
              $root.plexus.interop.testing.EchoRequest.SubMessage
            )
              return object;
            var message =
              new $root.plexus.interop.testing.EchoRequest.SubMessage();
            if (object.bytesField != null)
              if (typeof object.bytesField === 'string')
                $util.base64.decode(
                  object.bytesField,
                  (message.bytesField = $util.newBuffer(
                    $util.base64.length(object.bytesField)
                  )),
                  0
                );
          ...
          SubMessage.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults) {
              if (options.bytes === String) object.bytesField = '';
              else {
                object.bytesField = [];
              ...
              object.bytesField =
                options.bytes === String
                  ? $util.base64.encode(
                      message.bytesField,
                      0,
                      message.bytesField.length
                    )
                  : options.bytes === Array
                  ? Array.prototype.slice.call(message.bytesField)
                  : message.bytesField;
            if (
              message.stringField != null &&
              message.hasOwnProperty('stringField')
