...
export namespace interop {
  ...
  namespace samples {
    ...
    class GreetingService extends $protobuf.rpc.Service {
       ...
       */
      public unary(
        request: interop.samples.IGreetingRequest,
        callback: interop.samples.GreetingService.UnaryCallback
      ): void;
      ...
      public serverStreaming(
        request: interop.samples.IGreetingRequest,
        callback: interop.samples.GreetingService.ServerStreamingCallback
      ): void;
      ...
      public clientStreaming(
        request: interop.samples.IGreetingRequest,
        callback: interop.samples.GreetingService.ClientStreamingCallback
      ): void;
      ...
      public duplexStreaming(
        request: interop.samples.IGreetingRequest,
        callback: interop.samples.GreetingService.DuplexStreamingCallback
      ): void;
    ...
    class GreetingRequest {
      ...
      public static encodeDelimited(
        message: interop.samples.IGreetingRequest,
      ...
      public static toObject(
        message: interop.samples.GreetingRequest,
    ...
    class GreetingResponse {
       ...
       */
      public static encodeDelimited(
        message: interop.samples.IGreetingResponse,
        writer?: $protobuf.Writer
      ): $protobuf.Writer;
       ...
       */
      public static toObject(
        message: interop.samples.GreetingResponse,
        options?: $protobuf.IConversionOptions
      ): { [k: string]: any };
