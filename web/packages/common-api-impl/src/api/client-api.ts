...
export interface InteropPeer extends InteropClient, InteropServer, InteropPeerDescriptor {
   ...
   */
  onConnectionStatusChanged(callback: (status: ConnectionStatus) => void): Subscription;
   ...
   */
  onDisconnected(callback: (error?: Error) => void): Subscription;
}
...
export interface InteropClient {
   ...
   */
  subscribe(stream: string | Stream, observer: StreamObserver, args?: any): Promise<StreamSubscription>;
