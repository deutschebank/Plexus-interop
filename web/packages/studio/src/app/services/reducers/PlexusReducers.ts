...
import { Application, ConsumedMethod, InteropRegistryService, ProvidedMethod } from '@plexus-interop/metadata';
...
import { getPayload, TypedAction } from './TypedAction';
...
export function reducer(state: StudioState = initialState, action: Action): StudioState {
  switch (action.type) {
