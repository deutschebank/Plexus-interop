...
export namespace interop {
  ...
  class AppLauncherService extends $protobuf.rpc.Service {
     ...
     */
    public appLaunchedEventStream(
      request: google.protobuf.IEmpty,
      callback: interop.AppLauncherService.AppLaunchedEventStreamCallback
    ): void;
  ...
  class AppLaunchRequest implements IAppLaunchRequest {
    ...
    public static toObject(
      message: interop.AppLaunchRequest,
  ...
  class AppLaunchReferrer implements IAppLaunchReferrer {
     ...
     */
    public static toObject(
      message: interop.AppLaunchReferrer,
      options?: $protobuf.IConversionOptions
    ): { [k: string]: any };
  ...
  class AppLaunchResponse implements IAppLaunchResponse {
     ...
     */
    public static toObject(
      message: interop.AppLaunchResponse,
      options?: $protobuf.IConversionOptions
    ): { [k: string]: any };
  ...
  class AppLaunchedEvent implements IAppLaunchedEvent {
     ...
     */
    public static toObject(
      message: interop.AppLaunchedEvent,
      options?: $protobuf.IConversionOptions
    ): { [k: string]: any };
