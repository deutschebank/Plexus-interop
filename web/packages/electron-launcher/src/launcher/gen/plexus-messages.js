...
$root.interop = (function() {
    ...
    interop.AppLauncherService = (function() {
         ...
         * @variation 1
         */
        Object.defineProperty(AppLauncherService.prototype.launch = function launch(request, callback) {
         ...
         * @variation 1
         */
        Object.defineProperty(AppLauncherService.prototype.appLaunchedEventStream = function appLaunchedEventStream(request, callback) {
            return this.rpcCall(appLaunchedEventStream, $root.google.protobuf.Empty, $root.interop.AppLaunchedEvent, request, callback);
        }, "name", { value: "AppLaunchedEventStream" });
    ...
    interop.AppLaunchRequest = (function() {
        ...
        AppLaunchRequest.encode = function encode(message, writer) {
            ...
            if (message.launchParamsJson != null && Object.hasOwnProperty.call(message, "launchParamsJson"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.launchParamsJson);
            if (message.launchMode != null && Object.hasOwnProperty.call(message, "launchMode"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.launchMode);
            if (message.suggestedAppInstanceId != null && Object.hasOwnProperty.call(message, "suggestedAppInstanceId"))
                $root.interop.UniqueId.encode(message.suggestedAppInstanceId, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.referrer != null && Object.hasOwnProperty.call(message, "referrer"))
                $root.interop.AppLaunchReferrer.encode(message.referrer, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            return writer;
        };
        ...
        AppLaunchRequest.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.suggestedAppInstanceId = $root.interop.UniqueId.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.referrer = $root.interop.AppLaunchReferrer.decode(reader, reader.uint32());
                    break;
                default:
        ...
        AppLaunchRequest.verify = function verify(message) {
            ...
            if (message.suggestedAppInstanceId != null && message.hasOwnProperty("suggestedAppInstanceId")) {
                var error = $root.interop.UniqueId.verify(message.suggestedAppInstanceId);
                if (error)
                    return "suggestedAppInstanceId." + error;
            }
        ...
        AppLaunchRequest.fromObject = function fromObject(object) {
            ...
            if (object.suggestedAppInstanceId != null) {
                if (typeof object.suggestedAppInstanceId !== "object")
                    throw TypeError(".interop.AppLaunchRequest.suggestedAppInstanceId: object expected");
                message.suggestedAppInstanceId = $root.interop.UniqueId.fromObject(object.suggestedAppInstanceId);
            }
            if (object.referrer != null) {
                if (typeof object.referrer !== "object")
                    throw TypeError(".interop.AppLaunchRequest.referrer: object expected");
                message.referrer = $root.interop.AppLaunchReferrer.fromObject(object.referrer);
            }
            return message;
        };
        ...
        AppLaunchRequest.toObject = function toObject(message, options) {
            ...
            if (message.launchMode != null && message.hasOwnProperty("launchMode"))
                object.launchMode = options.enums === String ? $root.interop.AppLaunchMode[message.launchMode] : message.launchMode;
            if (message.suggestedAppInstanceId != null && message.hasOwnProperty("suggestedAppInstanceId"))
                object.suggestedAppInstanceId = $root.interop.UniqueId.toObject(message.suggestedAppInstanceId, options);
            if (message.referrer != null && message.hasOwnProperty("referrer"))
                object.referrer = $root.interop.AppLaunchReferrer.toObject(message.referrer, options);
            return object;
        };
    ...
    interop.AppLaunchReferrer = (function() {
        ...
        AppLaunchReferrer.encode = function encode(message, writer) {
            ...
            if (message.connectionId != null && Object.hasOwnProperty.call(message, "connectionId"))
                $root.interop.UniqueId.encode(message.connectionId, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AppLaunchReferrer.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AppLaunchReferrer.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.interop.AppLaunchReferrer();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.connectionId = $root.interop.UniqueId.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        AppLaunchReferrer.fromObject = function fromObject(object) {
            if (object instanceof $root.interop.AppLaunchReferrer)
                return object;
            ...
            if (object.appInstanceId != null) {
                if (typeof object.appInstanceId !== "object")
                    throw TypeError(".interop.AppLaunchReferrer.appInstanceId: object expected");
                message.appInstanceId = $root.interop.UniqueId.fromObject(object.appInstanceId);
            }
            if (object.connectionId != null) {
                if (typeof object.connectionId !== "object")
                    throw TypeError(".interop.AppLaunchReferrer.connectionId: object expected");
                message.connectionId = $root.interop.UniqueId.fromObject(object.connectionId);
            }
            return message;
        };
        ...
        AppLaunchReferrer.toObject = function toObject(message, options) {
            ...
            if (message.connectionId != null && message.hasOwnProperty("connectionId"))
                object.connectionId = $root.interop.UniqueId.toObject(message.connectionId, options);
            return object;
        };
    ...
    interop.AppLaunchedEvent = (function() {
        ...
        AppLaunchedEvent.encode = function encode(message, writer) {
            ...
            if (message.referrer != null && Object.hasOwnProperty.call(message, "referrer"))
                $root.interop.AppLaunchReferrer.encode(message.referrer, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AppLaunchedEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AppLaunchedEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.interop.AppLaunchedEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        AppLaunchedEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.interop.AppLaunchedEvent)
                return object;
            var message = new $root.interop.AppLaunchedEvent();
            if (object.appInstanceId != null) {
                if (typeof object.appInstanceId !== "object")
                    throw TypeError(".interop.AppLaunchedEvent.appInstanceId: object expected");
                message.appInstanceId = $root.interop.UniqueId.fromObject(object.appInstanceId);
            }
            if (object.appIds) {
            ...
            if (object.referrer != null) {
                if (typeof object.referrer !== "object")
                    throw TypeError(".interop.AppLaunchedEvent.referrer: object expected");
                message.referrer = $root.interop.AppLaunchReferrer.fromObject(object.referrer);
            }
            return message;
        };
