...
export class ElectronAppLauncherClientBuilder {
  ...
  public withAppLauncherServiceInvocationsHandler(
    invocationsHandler: AppLauncherServiceInvocationHandler
  ...
  public connect(): Promise<ElectronAppLauncherClient> {
    return new ContainerAwareClientAPIBuilder()
      ...
      .withTypeAwareUnaryHandler(
        ...
        plexus.interop.AppLaunchRequest,
        plexus.interop.AppLaunchResponse
      )
      .connect()
      .then((genericClient: GenericClientApi) => new ElectronAppLauncherClientImpl(genericClient));
  }
}
