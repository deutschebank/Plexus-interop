...
import { AppRegistryService, InteropRegistryProvider, InteropRegistryService } from '@plexus-interop/metadata';
...
export class Broker {
  ...
  constructor(
    ...
    this.connectionProcessor = new ClientConnectionProcessor(
      authHandler,
      clientRequestProcessor,
      this.appLifeCycleManager
    );
