...
import { ClientProtocolHelper, clientProtocol as plexus, SuccessCompletion, UniqueId } from '@plexus-interop/protocol';
...
export class ProxyAuthenticationHandler implements TransportChannel {
  ...
  public open(observer: ChannelObserver<AnonymousSubscription, ArrayBuffer>): void {
    ...
    observer.next(
      ClientProtocolHelper.connectRequestPayload({
